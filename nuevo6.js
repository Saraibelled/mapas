console.log('test 03 - subtle forward adjustment');
      ...
      try {
        ...
        const canvas = await window.html2canvas(systemContainer, {
          ...
          onclone: (clonedDocument) => {
            ...
            if (clonedContainer) {
              // Estilo del lienzo para la foto final
              Object.assign(clonedContainer.style, {
                width: '600px',
                height: '940px', // Un incremento moderado de altura
                containerType: 'unset',
                maxHeight: 'unset',
                aspectRatio: 'unset',
                maxWidth: 'unset',
                padding: '20px 0px 140px', // Padding inferior de 140px
                backgroundColor: '#ffffff'
              });
              ...
              // REPOSICIONAMIENTO SUTIL (73% en vez de 77%) para evitar solapes en la imagen final
              const currentSystem = document.querySelector('.v-n-toi-selector__item.is-active')?.getAttribute('data-system');
              ...
              // Mantener el campo táctico verde en su proporción de 790px de alto
              ...
              if (clonedFooter) {
                ...
                // Situar el pie de foto a 20px del fondo de forma absoluta
